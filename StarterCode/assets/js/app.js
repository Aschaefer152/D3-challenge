...
//  console.log(chartdata) see below after d3.csv
...
function xScale(chartdata, chosenXAxis) {
  ...
  // data.csv defined Healthcare vs. Poverty data = poverty,povertyMoe,healthcare,healthcareLow,healthcareHigh
...
// // #################### 5.  chartGroup Append Title   ###############//
  ...
  var yTitle = chartGroup.append("text")
    ...
    // var xTitle = chartGroup.append("text")
    // .attr("y", 0 - margin.left)
    // .attr("x", 0 - (height / 2))
    // .attr("dy", "1em")
    // .classed("axis-text", true)
